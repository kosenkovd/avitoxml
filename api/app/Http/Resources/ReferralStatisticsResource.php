 ...
 */
class ReferralStatisticsResource extends JsonResource
{
    ...
    public function toArray($request): array
    {
        return [
            ...
            'totalProfit' => $this->totalMasterProfit ? (float)$this->totalMasterProfit : 0,
            'balance' => $this->balance,
            'referralsCount' => $this->referralsCounter,
            'activeReferralsCount' => $this->activeReferralsCounter,
            'referralIncome' => $this->referralIncome
        ];
    }
}
